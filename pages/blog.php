...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="../bootstrap-5.3.0-dist/node_modules/bootstrap/dist/css/bootstrap.min.css">
      ...
      <section class="py-5 text-center container">
        <div class="row py-lg-5">
          <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light">Blog du club</h1>
            <p class="lead text-body-secondary">Bienvenu sur notre blog. ici, vous retrouvez toutes les news sur le club et ses stars.</p>
          </div>
        </div>
      </section>
